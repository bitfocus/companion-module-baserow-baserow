const FILTER = [
    ...
    },
    {
        ...
        id: 'json_filter',
        label: 'JSON filter',
        tooltip: `A JSON serialized string containing the filter tree to apply to this view.\n` +
    ...
    },
    {
        ...
        label: 'Parameter',
        width: 7,
        isVisible: (options) => options.usefilter == 'text' && options.text_operator != "isempty" && options.text_operator != "isnotempty",
    },
